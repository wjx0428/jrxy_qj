		...
		<view class="main">
			...
			<view class="main-content">
				<view class="main-content-type">
					<view class="main-content-type-leaveType"
					...
					<view class="main-content-type-leaveSchool" style="
              position: absolute;
              left: calc(50% - 150rpx);
              font-weight: 40;
            ">
            ...
            ">
					...
					<view class="main-content-type-leaveDate" style="position: relative; padding-left: 185rpx">
						...
						<text class="blackFont" :style="leaveDateStyle()" style="margin-left: -10rpx">
							{{
                leave.state == "正在休假中"
                  ? "-"
                  : leave.startDate +
            ...
            ">我的 请假申请</view>
					<view class="main-content-info-left">
						<view class="time" style="width: auto"><text style="
                  color: #589fd5;
                  text-align: center;
                  padding-left: 10px;
                  padding-right: 10px;
                ">{{ leave.countDate }}</text></view>
                ...
                leave.twoCheck != ""
                  ...
                  : "1"
							...
							<text style="color: #589fd5; margin-left: 5px">查看></text></text><br />
						<view>请假原因：</view><text
							style="vertical-align: top; width: 77%; display: inline-block">{{ leave.reason }}</text>

						<br />
						<view class="main-content-info-left-file" style="width: 100%" v-if="leave.imgFile != ''"><text
								style="color: #9ea8b4">附件：</text>
							<image :src="leave.imgFile" @click="imgFileClick"></image>
						</view><br v-if="leave.imgFile != ''" />
						<view style="main-content-info-left-file">发起位置：</view><text
							style="color: #589fd5">{{ leave.address }}</text><br />
            ...
            ">审批流程记录</view>
                ...
                ">
								<text>
									...
									一级： {{ leave.oneCheck }} - 审批<text style="color: #00ca76">通过</text>(逾期处理)</text>
							</view>
							<view style="
                  position: absolute;
                  top: -6rpx;
                ...
                ">{{ leave.oneCheckDate }}</view>
                  ...
                  width: 72%;
                ">
								<text>二级：[{{ leave.twoCheckStatus }}]{{ leave.twoCheck }} -
                ...
                ">{{ leave.twoCheckDate }}</view>
                  ...
                  width: 72%;
                ">
								<text>三级：[{{ leave.threeCheckStatus }}]{{ leave.threeCheck }} -
									审批<text style="color: #00ca76">通过</text></text>
							</view><br />
							<view style="
                  position: absolute;
                ...
                ">{{ leave.twoCheckDate }}</view>
						...
						<view class="main-content-checkState-state-apply" style="margin-top: 10px"
				...
				<view class="main-content-clearInfo" v-if="leave.state == '已完成'">
					<view class="main-content-clearInfo-info">销假信息
						<view>所在位置：<text class="blackFont">{{
                leave.address
              }}</text></view>
					</view>
				</view>
				...
				<view class="main-content-bottom-btn" v-if="leave.state == '正在休假中'">
					<view>转发</view>
					<view>申请续假</view>
					<view style="background-color: #2f98e9; color: white" @click="clear">去销假</view>
				</view>
			</view>
		</view>
	</view>
